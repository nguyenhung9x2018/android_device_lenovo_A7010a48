...
DEVICE_PACKAGE_OVERLAYS += device/lenovo/k5fpr/overlay
PRODUCT_PACKAGE_OVERLAYS += device/lenovo/k5fpr/overlay # enable this to be able overlay a default wallpaper
...
# Seccomp policy
PRODUCT_COPY_FILES += \
    device/lenovo/k5fpr/seccomp/mediacodec.policy:system/vendor/etc/seccomp_policy/mediacodec.policy \
    device/lenovo/k5fpr/seccomp/mediaextractor.policy:system/vendor/etc/seccomp_policy/mediaextractor.policy
    
# HIDL
PRODUCT_COPY_FILES += \
    device/lenovo/k5fpr/hidl/manifest.xml:system/vendor/manifest.xml
